...
namespace RC1._0.Main
{
    public partial class MainForm : Form
    {
        ...
        {
            UserMana.ChangePass changepass = new UserMana.ChangePass();
            changepass.Show();
        }

        private void 添加账户_Click(object sender, EventArgs e)
        {
            UserMana.AddUser adduser = new UserMana.AddUser();
            adduser.Show();
        }
        ...
        {
            RentMana.RentAbnomal rentabnomal = new RentMana.RentAbnomal();
            rentabnomal.Show();
        }
